...
class OrderDecoder(Object):
    ...
    def decodeWhatIfInfoAndCommissionAndFees(self, fields) -> None: ...
    ...
    def decodeImbalanceOnly(self, fields, minVersionImbalanceOnly=...) -> None: ...
    ...
    def decodeIncludeOvernight(self, fields) -> None: ...
    def decodeCMETaggingFields(self, fields) -> None: ...
    def decodeSubmitter(self, fields) -> None: ...
