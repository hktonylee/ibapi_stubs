...
from ibapi.const import DOUBLE_INFINITY as DOUBLE_INFINITY, UNSET_DECIMAL as UNSET_DECIMAL, UNSET_DOUBLE as UNSET_DOUBLE, UNSET_INTEGER as UNSET_INTEGER
...
class Order(Object):
    ...
    shareholder: str
    imbalanceOnly: bool
    routeMarketableToBbo: Incomplete
    parentPermId: int
    ...
    deactivate: bool
    seekPriceImprovement: Incomplete
    whatIfType: Incomplete
    slOrderId: Incomplete
    slOrderType: str
    ptOrderId: Incomplete
    ptOrderType: str
    def __init__(self) -> None: ...
